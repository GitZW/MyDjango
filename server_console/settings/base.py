...
MIDDLEWARE_CLASSES = (
    'utils.middlewares.gatemiddleware.ConsoleGateMiddleware',  # 处理api访问的进入和进出记录.
    'django.contrib.sessions.middleware.SessionMiddleware',  # 支持session,为了前端登录.
    'utils.middlewares.authenticationmiddleware.ConsoleAuthenticationMiddleware',
    'utils.middlewares.requireloginmiddleware.RequireLoginMiddleware',  # 拦截所有未登陆的api, LoginRequireMiddleware配置里面的url除外.
    'corsheaders.middleware.CorsMiddleware',
    'utils.middlewares.apimiddleware.APIMiddleware',  # APIMiddleware允许view返回dict类型, 必须放在MIDDLEWARE_CLASSES的最后.
)

ROOT_URLCONF = 'server_console.urls'
...
REQUIRE_LOGIN_EXCLUDES = ['cuser_login',]
